...
import type { DashboardData } from "@/lib/utils/dashboard-data";
...
export default function DashboardClient({ data, session }: DashboardClientProps) {
              ...
              <div className="flex items-center justify-between">
                ...
                <div
                  className={`flex items-center justify-between ${
                    isPositive ? "bg-green-100 text-green-600" : "bg-red-100 text-red-700"
          ...
          <div className="overflow-x-auto">
            <table className="w-full table-auto min-w-[800px] border-collapse text-left">
              <thead className="text-gray-500 text-xs sm:text-sm">
                <tr>
                  <th className="px-5 py-4 border-b border-gray-200 first:pl-0">Date</th>
                  <th className="px-5 py-4 border-b border-gray-200 first:pl-0">Transaction ID</th>
                  <th className="px-5 py-4 border-b border-gray-200 first:pl-0">Customer</th>
                  <th className="px-5 py-4 border-b border-gray-200 first:pl-0">Total</th>
                  <th className="px-5 py-4 border-b border-gray-200 first:pl-0">Status</th>
                </tr>
              </thead>
              <tbody>
                {payments.map((p) => (
                  <tr key={p.id}>
                    ...
                    <td className="px-5 py-4 border-b border-gray-200 first:pl-0">
                      {p.order.customer.name} ({p.order.customer.phoneNumber})
                    </td>
                    <td className="px-5 py-4 border-b border-gray-200 first:pl-0">
